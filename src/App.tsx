    ...
    <>
      ...
      <div className={`gate-overlay ${!gateVisible ? 'gate-overlay--hide' : ''}`}>
        <div className="gate-overlay__content">
          ...
          <div className="gate-overlay__switch-box" onClick={() => handleToggle(!switchChecked)}>
      ...
      <div className="app">
        ...
        <Experience />
        <Portfolio />
        <CaseStudies onOpenCase={setActiveCase} />
        <Skills />
        <Certifications />
        <Education />
        <Contact />
      ...
      <CaseStudyModal activeCase={activeCase} onClose={() => setActiveCase(null)} />
    </>
  )
}
